<template>
  <div>
    <h2 class="page-title">
      Sing - <span class="fw-semi-bold">Package</span>&nbsp;
      <small>More than 2000 man-hours already invested!</small>
    </h2>
    <p class="lead">
      Over 8,000 developers worldwide chose our bootstrap admin templates to build their
      web applications, SAAS and E-Commerce platforms faster. Jump in to burn through your gig too!
    </p>
    <div class="row">
      <div class="col-sm-12 col-md-6">
        ...
        >
          <img
            class="rounded pull-left mb-1 me-3 image"
          ...
          <p class="text-muted">
            We spent another <span class="fw-semi-bold">500</span> man-hours
            developing and designing
            React version, to save you time and money.
          </p>
          <p>
            <a
      ...
      <div class="col-md-6 col-12">
        ...
        >
          <img
            class="rounded pull-left mb-1 me-3 image"
            src="../../assets/angularjs-logo.svg"
            width="80"
            alt="angular"
          >
          <h3>Angular 2+ Version</h3>
          <p class="text-muted">
            We spent around <span class="fw-semi-bold">500</span> man-hours
            developing and designing
            Angular version, to match high engineering requirements.
          </p>
          <p>
            <a
          ...
          <p>
            Our app is built on top of latest <strong>Angular 5.0</strong> version and
            uses <a href="https://webpack.js.org/">Webpack</a> Module Bundler and NPM as a package manager,
            so everything
            works out of the box! <br><br>
          </p>
          <div class="d-grid">
            <a
              class="btn btn-default btn-lg"
      ...
      <div class="col-12 col-md-6">
        ...
        >
          ...
          <p class="text-muted">
            We don't know about you but we're very
            excited that it's finally here!
            Our brand new Light Blue Angular version.
          </p>
          <p>
            <strong>Angular 1.0</strong> have so many opportunities in
            ...
            than arranging an outstanding end-user experience.
          </p>
          <p>
            <a
              href="https://reactjs.org/"
            ...
            among your top considerations when choosing the right framework.
          </p>
          <p>
            Angular version makes it possible by letting responsive, fast-loading and
            seamlessly-navigating application.
          </p>
          <div class="d-grid">
            <a
              class="btn btn-default btn-lg"
      ...
      <div class="col-md-6 col-12">
        ...
        >
          ...
          <p>
            ...
            value of &nbsp;<code>window.PJAX_ENABLED</code> global variable.
          </p>
          <p>
            Moreover, this version comes with three different color
            schemes which you can easily switch based on your choice.
          </p>
          <div class="d-grid">
            <a
              class="btn btn-default btn-lg"
      ...
      <div class="col-sm-12 col-md-6">
        ...
        >
          ...
          <h3>Vue 3 Version</h3>
          <p class="text-muted">
            Our latest version built with <span class="fw-semi-bold">Vue 3</span> and Vite.
          </p>
          <p>
            <a
          ...
          <p>
            This version is built with the latest <strong>Vue 3</strong> using the Composition API,
            <strong>Pinia</strong> for state management, and <strong>Vite</strong> for lightning-fast
            builds. It includes all the features of Sing App with modern best practices.
          </p>
          <div class="d-grid">
            <a
              class="btn btn-transparent btn-lg disabled"
              href="#"
            >You are here!</a>
          </div>
        </Widget>
...
<style src="./Package.scss" lang="scss" scoped />
