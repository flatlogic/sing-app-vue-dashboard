      ...
      <div class="col-12 col-md-6">
        ...
        >
          ...
          <div class="widget-padding-md w-100 h-100 text-start border rounded">
            ...
            <p>
              <ins>This line of text is meant to be treated as
                an addition to the document.</ins>
            </p>
          ...
          <div class="widget-padding-md w-100 h-100 text-start border rounded">
            <blockquote class="blockquote">
              <p>
                ...
                it gb-row, be formless, shapeless — like water. Empty your mind, be formless, shapeless — like water.
